...
from pytracking.features.extractor import MultiResolutionExtractor, MultiResolutionExtractor_Depth
...
def parameters():
    ...
    deep_feat = deep.ATOMResNet18_Depth(net_path=settings.checkpoints_path, output_layers=['layer3'], fparams=deep_fparams, normalize_power=2)
    # params.features = MultiResolutionExtractor([deep_feat])
    params.features = MultiResolutionExtractor_Depth([deep_feat])
