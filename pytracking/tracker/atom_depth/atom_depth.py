...
class ATOM_DEPTH(BaseTracker):
    ...
    def initialize(self, image, depth, info: dict) -> dict:
        ...
        # Song : Get init Depth Region ???
        # self.depth_pos = depth[:, ]
        ...
        # Extract and transform sample      # Song : with depth samples?
