...
#
#         print('Song in BackboneBase: return_layers = ', return_layers)
...
#     backbone = backbones.resnet50(output_layers='layer4', pretrained=backbone_pretrained)
#     model = Joiner(backbone, position_embedding)
#     model.num_channels = backbone.num_channels
#
#     return model

def build_backbone(backbone_name='resnet50', backbone_pretrained=True, hidden_dim=256, position_embedding='learned'):

    position_embedding = build_position_encoding(hidden_dim, position_embedding=position_embedding)

    if backbone_name == 'resnet18':
        num_channels = 512
        backbone = backbones.resnet18(output_layers=['layer4'], pretrained=backbone_pretrained)
    else:
        num_channels = 2048
        backbone = backbones.resnet50(output_layers=['layer4'], pretrained=backbone_pretrained)
