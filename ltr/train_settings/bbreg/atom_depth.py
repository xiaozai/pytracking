...
from ltr.dataset import Lasot, TrackingNet, MSCOCOSeq, Got10k, CDTB
from ltr.data import processing, sampler, LTRLoader
# import ltr.models.bbreg.atom as atom_models
import ltr.models.bbreg.atom_depth as atom_models
...
def run(settings):
    ...
    settings.description = 'ATOM IoUNet with default settings, but additionally using CDTB for training.'
    ...
    # Validation datasets
    cdtb_val = CDTB(settings.env.cdtb_dir, split='val')
    ...
    data_processing_train = processing.ATOMProcessing_Depth(search_area_factor=settings.search_area_factor,
    ...
    data_processing_val = processing.ATOMProcessing_Depth(search_area_factor=settings.search_area_factor,
                                                          output_sz=settings.output_sz,
                                                          center_jitter_factor=settings.center_jitter_factor,
                                                          scale_jitter_factor=settings.scale_jitter_factor,
                                                          mode='sequence',
    ...
    actor = actors.AtomActor_Depth(net=net, objective=objective)
